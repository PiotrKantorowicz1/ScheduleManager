...
namespace Manager.Struct.Services
{
    public class HandlerTask : IHandlerTask
    {
        ...
        private Func<ManagerException, Task> _onCustomErrorAsync;
        private Func<ManagerException, Logger, Task> _onCustomErrorWithLoggerAsync;
        ...
        public IHandlerTask OnCustomError(Func<ManagerException, Task> onCustomError,
        ...
        public IHandlerTask OnCustomError(Func<ManagerException, Logger, Task> onCustomError,
            bool propagateException = false, bool executeOnError = false)
        {
        ...
        {
            var customException = exception as ManagerException;
